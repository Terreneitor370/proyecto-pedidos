...
import { AuthProvider, AuthGate, LoginStatus } from "./modules/auth";
      ...
      <AuthGate>
        <div className="app-shell">
          ...
          <main className="app-shell__content">
            <section
              className={
                activeView === "catalog" ? "app-view app-view--active" : "app-view"
              }
            >
              <Catalog />
            </section>
            ...
            <section
              className={
                activeView === "cart" ? "app-view app-view--active" : "app-view"
              }
            >
            ...
            <section
              className={
                activeView === "checkout" ? "app-view app-view--active" : "app-view"
              }
            >
              <CheckoutPage
